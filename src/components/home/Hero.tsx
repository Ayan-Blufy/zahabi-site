          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <h1 className="text-2xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                ...
                <span className="text-gold-dark"> Gold</span> – Borrow, Invest,
                Grow
              </h1>
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                Collateralize gold for instant loans or invest in gold-backed
                tokens with zero physical storage.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <CustomButton
                variant="outline"
                className="border-zahabi-cream-200 hover:bg-zahabi-cream-50 hover:text-zahabi-cream-700"
              >
                Start Investing 
              </CustomButton>
            </div>
