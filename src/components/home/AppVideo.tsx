  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve({
        ...
        url: "https://zahabi-test-78997878.s3.ap-south-1.amazonaws.com/introduction+to+Zahabi.mp4",
...
const AppVideo = () => {
  ...
  return (
    <section className="py-20 bg-white" id="app-video">
      <div className="container mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-xl border border-zahabi-gold/20">
          ...
          <button 
            onClick={togglePlay}
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 flex items-center justify-center rounded-full  text-white hover:bg-zahabi-gold transition-all duration-300 focus:outline-none"
          >
            {isPlaying ? (
